...
(function() {
    ...
    async function applyLight(){
      if(await GM.getValue("dark") == 10)return;
      await rmDark();
      var style2 = `#btCopyContainer{margin-top:-9px;margin-right:-9px;float:right;background-color:#303030;border-radius:2.5px}button#btDark:focus{outline:0}button#btDark{color:#e3e3e3;float:right;margin-top:10px;height:20px;margin-right:10px;background:transparent !important;border:none}div#btDarkContainer{height:auto;width:0px;margin:auto;float:right;margin-top:5px}button.btSubmit{cursor:pointer;background-color:#e0e0e0 !important;color:#858585 !important;border:none;text-align:left !important;font-size:8pt;padding:4px}button.btSubmit:focus{outline:0}`;
      var elem2 = document.createElement('style');
      elem2.id = 'tlx-dark-theme-additional';
      elem2.type = 'text/css';
      elem2.innerText = style2;
