...
**Update 19/06/21**:<br>- There have been a few changes in tlx's website which made the script broken. This issue have been fixed. Please update the script to the newest version. Expect some bugs.
